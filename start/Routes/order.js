...
Route.get('/app/ordersDriver', 'OrderController.indexDriverSeller') 
...
Route.post('/app/drivrordercomplete', 'OrderController.drivrOrderComplete')
Route.post('/app/drivrOrderMapStatus', 'OrderController.drivrOrderMapStatus')
